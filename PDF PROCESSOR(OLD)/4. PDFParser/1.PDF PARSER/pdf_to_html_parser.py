...
def extract_pdf_page(filename):
    ...
    output_file_folder = Path(EXTRACTED_PATH, input_file_name)
...
def extract_pdf_images(filename):
    ...
    input_file_name = Path(filename).stem
    output_images_path = Path(EXTRACTED_PATH, input_file_name, "images")
...
def extract_pdf_tables(filename):
    ...
    input_file_name = Path(filename).stem
    output_tables_path = Path(EXTRACTED_PATH, input_file_name)
